...
export const HowItWorks = () => {
    ...
    return (
        <section className="py-8 md:py-10 bg-[#F0EDE6]">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                    {steps.map((step, index) => (
                        <motion.div 
                            ...
                            className="card-premium p-4 text-center group hover:border-[#C9B37F]/40 transition-all"
                        >
                            {/* Icon */}
                            <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#F8F5F0] to-[#F0EDE6] border border-[#EDE9E0] mb-2 group-hover:scale-105 transition-transform group-hover:border-[#C9B37F]/30">
                                <step.icon size={20} className="text-[#0F172A]" />
                            </div>
